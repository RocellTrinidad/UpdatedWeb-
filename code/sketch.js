...
let backgroundMusic; // Declare the background music variable

function preload() {
  font = loadFont("2.ttf");
  soundFormats('mp3'); // Ensure mp3 format is supported
 backgroundMusic =  loadSound('song1.mp3'); // Load the background music
}
